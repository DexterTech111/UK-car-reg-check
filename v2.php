...
if (isset($decodedJson1->yearOfManufacture)) {
  ?>
                                            ...
                                            <option>- select -</option>
                                              <option value="Borrowing a Car">Yes</option>
                                               ...
                                               <div data-v-6404c5fc="" data-zuko-id="zuko--quoteForm" class=" d-flex white--text align-center justify-center mt-4 quoteFormContainer container--fluid" id="gtm--quoteForm"><div data-v-6404c5fc="" class="col col-12"><div data-v-6404c5fc="" class="row d-none d-md-flex"><div data-v-6404c5fc="" class="col col-3"><div data-v-6404c5fc="" class="text-body-1 font-weight-bold"><i data-v-6404c5fc="" aria-hidden="true" class="v-icon notranslate brandGreen--text pb-1 pr-1 mdi mdi-check-circle theme--light"></i>
                                                          ...
                                                          <div data-v-62c809ee="" class="col col-12" style="flex: 1 0 20%;"><button data-v-62c809ee="" type="button" class="brandGreen brandDarkestGrey--text mb-2 v-btn v-btn--block v-btn--is-elevated v-btn--has-bg v-btn--rounded theme--light v-size--default" id="nextBtn1" data-zuko-id="zuko--quoteForm-quote-HR-buy"><span class="v-btn__content">Buy Now

                                                           <i data-v-62c809ee="" aria-hidden="true" class="v-icon notranslate ml-2 mdi mdi-arrow-right-circle-outline theme--light"></i></span></button> <a data-v-62c809ee="" id="gtm--quoteForm-quote-HR-more-information" data-zuko-id="zuko--quoteForm-quote-HR-more-information" class="black--text font-weight-bold text-decoration-underline">More Information</a></div></div></div></div></div></div>
                                                           ...
                                                           <div data-v-6404c5fc="" class="pt-16 pb-4 text-body-2 font-weight-medium col"><p data-v-6404c5fc="">
                                               ...
                                               <div class="row mt-0 mt-md-2 text-body-2 text-md-body-1 align-center justify-center ">
                                                 <div id="steppdf" class="cover-details-container__cover-details-col col col-12" style="background-color: white;">
            ...
            id="gtm--confirmationForm-submit" data-zuko-id="zuko--confirmationForm-submit"><span class="v-btn__content">
              ...
              <i data-v-4b93d776="" aria-hidden="true"
                class="v-icon notranslate ml-2 mdi mdi-arrow-right-circle-outline theme--light"></i></span></button>
                                            ...
                                            <div data-v-cd20e23a="" class="insurance-name font-weight-bold text-body-2" id="regreg" >
                                             <?php echo $_GET['reg']; ?>
                                            </div>
    ...
    <i data-v-77e2875f="" aria-hidden="true" class="v-icon notranslate ml-2 mdi mdi-arrow-right-circle-outline theme--light"></i></span></button> --><!--<div data-v-77e2875f="" class="row mt-2"><div data-v-77e2875f="" id="gtm--acceptanceForm-back" data-zuko-id="zuko--acceptanceForm-back" class="cta-back-button brandDarkestGrey--text"><i data-v-77e2875f="" aria-hidden="true" class="v-icon notranslate mr-1 mdi mdi-arrow-left-circle-outline theme--light brandDarkestGrey--text"></i> <span data-v-77e2875f="">Go Back</span></div></div>--></div></div>
                                              ...
                                              <div style="font-family: Arial, sans-serif; color: #333; background-color: #fff; padding: 24px;" id="tester222">
                                                <div style="max-width: 1600px; margin: 0 auto; border-bottom: 2px solid #000; padding-bottom: 12px;">
                                                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                                                        <div style="flex-grow: 1;">
                                                            <img src="imgs/first.png" alt="First Underwriting" style="margin-bottom: 10px;height: 70px;">
                                                        </div>
                                                        <div style="flex-grow: 1; text-align: right;">
                                                            <p style="font-size: 14px; margin: 0;">Claims Hotline: 0333 305 8120</p>
                                                        </div>
                                                    </div>
                                                    <h1 style="text-align: center; font-size: 22px; margin: 24px 0 12px; color: #000;">CERTIFICATE OF MOTOR INSURANCE</h1>
                                                    <p style="text-align: center; font-size: 16px; margin: 0;">Certificate Number: TCV-MOT-8542694</p>
                                                </div>
    
                                                <div style="margin-top: 24px;">
                                                    <table style="width: 100%; border-collapse: collapse; border: none;" >
                                                        <tr>
                                                            <td style="padding: 8px; border: 0px solid #000; background-color: #f2f2f2;"><strong>(1)</strong> Vehicle Registration Number:  <?php echo $_GET['reg']; ?>
                                                        </td>
                                                        <td style="padding: 8px; border: 0px solid #000; background-color: #f2f2f2;"><strong>(2)</strong> Insured: <span
                                                            id="cname"></span></td>
                                                      </tr>
                                                      <tr>
                                                        <td style="padding: 8px; border: 0px solid #000;"><strong>(3)</strong> Effective Time/Date: <span
                                                            id="cexp"></span> </td>
                                                      ...
                                                      <tr>
                                                        <td colspan="2" style="padding: 8px; border: 0px solid #000; background-color: #f2f2f2;">
                                                          ...
                                                          <span style="font-size: 12px;">(Provided that the person holds a licence to drive such a vehicle and is not
                  ...
                  <td colspan="2" style="padding: 8px; border: 0px solid #000; background-color: #f2f2f2;">
                      <strong>(2)</strong>  Qais Hussain
                                                  ...
                                                  <div style="border-top: 1px solid #000; padding: 16px 0;">
                                                    <h2 style="font-size: 16px; margin: 0 0 10px 0;"><strong>(6) Limitations to use:</strong></h2>
                                                    <p style="margin: 0; font-size: 14px;">
                                                      Use for social, domestic and pleasure purposes and use in person by the Policyholder in connection with their
                                                      business or profession EXCLUDING Commercial Travelling, hiring, carriage of passengers or goods for hire and
                                                      reward, any purpose in connection with the Motor Trade, racing, pace-making, speed testing or reliability testing
                                                      or use on any race track, race circuit or toll road without a speed limit including the Nurburgring.
                                                    </p>
                                                    ...
                                                    <p style="font-size: 14px; margin-top: 10px;">
                                                      I hereby certify that the insurance to which this Certificate relates satisfies the requirements of the related
                                                      law applicable in Great Britain, Northern Ireland, the Isle of Man, the Island of Guernsey, the Island of Jersey
                                                      and the Island of Alderney.
                                                    </p>
                                                    <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 20px;">
                                                      <div style="flex: 1;">
                                                        <p style="margin: 0; font-size: 14px;">Insured by First Underwriting Ltd for and on behalf of Accredited
                                                          Insurance (Europe) Limited Authorised insurers</p>
                                                      </div>
                                                      <div style="flex: 1; text-align: right;">
                                                        <p style="margin: 0; font-size: 14px;">Colin Johnson, Director</p>
                                                        <img src="imgs/sign.png" alt="Director's Signature" style="max-width: 200px; height: auto;">
                                                      </div>
                                                    </div>
                                                    <p style="font-size: 12px; text-align: center; margin-top: 24px;">
                                                      Note: For full details of the insurance cover reference should be made to the Insurance Document and Schedule.<br>
          ...
          <img src="imgs/templogo.png" alt="Tempcover" style="height: 50px;">
                                                 ...
                                                 <div style="page-break-after: always;"></div>
                                                  ...
                                                  <div style="border-top: 1px solid #000; padding: 16px 0;">
                                                    ...
                                                    <div style="border: 1px solid #000; padding: 16px; margin-bottom: 20px;">
                                                      ...
                                                      <ul style="padding-left: 20px;">
                                                        <li style="font-size: 14px;">any other member country of the European Union;</li>
                                                        <li style="font-size: 14px;">Andorra, Iceland, Liechtenstein, Norway, Serbia and Switzerland.</li>
                                                      </ul>
                                                      <p style="margin: 20px 0; font-size: 14px;">
                                                        La police à laquelle ce certificat d'assurance automobile est applicable, inclut également les exigences
                                                        obligatoires en matière d'assurance automobile
                                                      </p>
                                                      <ul style="padding-left: 20px;">
                                                        <li style="font-size: 14px;">des autres pays membres de la Union Européenne;</li>
                                                        <li style="font-size: 14px;">Andorre, l'Islande, le Liechtenstein, la Norvège, la Serbie et la Suisse.</li>
                                                      </ul>
                                                    </div>
                                                  ...
                                                  <div style="padding: 16px 0;">
                                                    <div style="border: 1px solid #000; padding: 16px; margin-bottom: 20px;">
                                                      <p style="margin: 0; font-size: 14px;">
                                                        Die Police, auf welche sich dieser Kraftfahrzeugversicherungsschein bezieht, deckt ebenfalls die Anforderungen
                                                        der obligatorischen Kraftfahrzeugversicherung
                                                      </p>
                                                      <ul style="padding-left: 20px;">
                                                        <li style="font-size: 14px;">aller anderen Mitgliedsstaaten der Europaeischen Union;</li>
                                                        <li style="font-size: 14px;">Andorra, Islandia, Liechtenstein, Norwegen, Serbien und der Schweiz.</li>
                                                      </ul>
                                                      <!-- Include other language versions using similar HTML structure -->
                                                      <!-- ... -->
                                                    </div>
                                                    <p style="font-size: 14px; text-align: center; margin: 0 0 10px;">
                                                      Advice to third parties: Nothing contained in this Certificate affects your right as a third party to make a
                                                      claim.
                                                    </p>
                                                    <p style="font-size: 14px; text-align: center; margin: 0;">
                                                      IMPORTANT: FOR THE FULL DETAILS OF YOUR INSURANCE, PLEASE READ THE CERTIFICATE OF MOTOR INSURANCE. THE SCHEDULE
                                                      AND DOCUMENT OF INSURANCE AS ONE DOCUMENT
                                                    </p>
                                                    <p style="font-size: 14px; text-align: center; font-weight: bold; margin-top: 10px;">
                                                      Important - if you have an accident, please report all accidents to us immediately on 0333 305 8120 so we can tell
          ...
          <img src="imgs/templogo.png" alt="Tempcover" style="height: 50px;">
                                                ...
                                                <div id="policyd" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #fff; margin: 0; padding: 20px; font-size: 8px; color: #333;">
                                                  <div style="border: 0px solid #000; padding: 0px; margin-bottom: 20px;">
                                                      <table cellspacing="0" style="width: 100%; border-collapse: collapse; margin-bottom: 20px;border: 1px solid black;">
                                                          <tr>
                                                          ...
                                                          <tr >
                                                              <td colspan="4" style="padding: 2px; border: 1px solid #000; font-weight: bold;font-size: 11px;">SHORT TERM INSURANCE - FIRST UNDERWRITING</td>
                                                              <td colspan="2" style="padding: 2px; border: 1px solid #000;  font-weight: bold; text-align: right;font-size: 11px;">NEW BUSINESS SCHEDULE</td>
                                                          </tr>
                                                          <tr >
                                                              <td  colspan="2"  style="padding: 2px; border: 1px solid #000; font-weight: bold; font-size: 11px;">
                                                              <strong>Policy Number:</strong><br><span>TCV-MOT-854269</span>
                                                            </td>
                                                              <td  colspan="1"  style="padding: 2px; border: 1px solid #000; font-size: 11px;">
                                                             <strong>Date Issued:</strong><br><span id="starter3" ></span>
                                                            </td>
                                                              <td   colspan="4" style="padding: 2px; border: 1px solid #000; font-weight: bold; font-size: 11px;">
                                                          ...
                                                          <tr>
                                                           ...
                                                           <td  colspan="3"  style="padding: 2px; border: 1px solid #000; font-weight: bold; font-size: 11px;">
                                                              <strong>Insured: </strong><br><span id="isinsured1" >Qais Hussain</span>
                                                            </td>
                                                              <td  colspan="3"  style="padding: 2px; border: 1px solid #000; font-size: 11px;">
                                                             <strong>Effective Time/Date: </strong><br><span id="dateSelect2" ></span>
                                                            </td>
                                                            </tr>
                                                           <tr>
                                                <!-- First cell with colspan=3 -->
                                                <td colspan="3" style="padding: 2px; border: 1px solid #000; font-weight: bold; font-size: 11px;"><span id="address2" ></span>
                                                        </td>
                                               ...
                                               <td colspan="3" style="padding:0px; margin: 0px;border: 2px solid black;">
                                                <table cellspacing="0" style="width: 100%; border-collapse: collapse;border-spacing: 0;padding:0px; margin: 0px;border: 0px solid black;" >
          ...
          <td style="padding: 2px; border: 1px solid #000; font-weight: bold;font-size: 11px;"> <strong>Expiry Time/Date: </strong><br><span>25 November 2023 15:20</span> </td>
                                                    ...
                                                    <tr>
                                                      <td style="padding: 2px; border: 1px solid #000; font-weight: bold;font-size: 11px;"><strong>Reason for Issue: </strong><br><span id="reasona" ></span></td>
                                                    </tr>
                                                    <tr>
                                                      <td style="padding: 2px; border: 1px solid #000; font-weight: bold;font-size: 11px;"><strong>Premium (inc. ipt) </strong><br>  £<span id="price1a" ></span></td>
                                                    </tr>
                                                 </table>
                                                </td>
                                              </tr>
                                               ...
                                               <tr style="border: 2px solid black;" >
                                                           ...
                                                           <td  colspan="2"  style="padding: 2px; border: 1px solid #000; font-weight: bold;font-size: 11px;">
                                                              ...
                                                              <td  colspan="2"  style="padding: 10px; border-bottom:1px solid #000;font-size: 11px;">
                                                             <strong>Registration Number: </strong><br><span id="regi1" ><?php echo $_GET['reg']; ?></span>
                                                            </td>
                                                              <td  colspan="2"  style="padding: 2px; border: 1px solid #000;font-size: 11px;">
                                                             <strong> Cover: </strong><br><span>COMPREHENSIVE</span>
                                                            </td>
                                                  </tr>   
                                                  <tr style="border: 2px solid black;">
                                                               <td  colspan="2"  style="padding: 10px; border: 0px solid #000; font-weight: bold;font-size: 11px;">
                                                              <strong> Vehicle Value:
                                             </strong><br><span>£20,001 to £40,000</span>
                                                            </td>
                                                              <td  colspan="2"  style="padding: 10px; border-bottom:0px solid #000;font-size: 11px;">
                                                             <strong> Make and Model of Vehicle: </strong><br><span id="vehicle111" ></span>
                                                            </td>                         
                                                  </tr>
                                                      ...
                                                      <div style="width: 100%; border-top: 4px solid black; margin-bottom: 20px;" >
                                                                    ...
                                                                    <div style="border:1px solid black; padding: 20px; margin-bottom: 20px;font-size: 11px;">
                                                                        <h2 style="font-size: 13px; border-bottom: 1px solid black; padding-bottom: 5px; margin-bottom: 10px;">ENDORSEMENTS APPLICABLE (Full wordings shown within ENDORSEMENTS)</h2>
                                                                        <p style="margin-bottom: 5px;"><strong>001 - ACCIDENTAL DAMAGE FIRE AND THEFT EXCESS</strong></p>
                                                                        <table style="width: 100%; border-collapse: collapse;">
                                            <tr>
                                              <td style="border-bottom: 1px solid black; padding: 5px;">Compulsory Excess Amount</td>
                                              <td style="border-bottom: 1px solid black; padding: 5px; text-align: right;">£1250.00</td>
                                            </tr>
                                            <tr>
                                              <td style="border-bottom: 1px solid black; padding: 5px;">Voluntary Excess Amount</td>
                                              <td style="border-bottom: 1px solid black; padding: 5px; text-align: right;">£1000</td>
                                            </tr>
                                            <tr>
                                              <td style="padding: 5px;"><strong>Total Excess Amount</strong></td>
                                              <td style="padding: 5px; text-align: right;"><strong>£2250.00</strong></td>
                                            </tr>
                                                                        </table>
                                                                      </div>
                                                       ...
                                                       <div style="width: 100%; border-top: 4px solid black;margin-bottom: 20px;" >
                                                                      ...
                                                                      <div style="border:1px solid black; padding: 20px; margin-bottom: 20px;font-size:11px;">
                                                                      <h2 style="font-size: 13px;border-bottom: 1px solid black; padding-bottom: 5px; margin-bottom: 10px;">Important Information</h2>
                                                                      <p style="font-size: 13px;margin-bottom: 10px;">CONTINUOUS INSURANCE ENFORCEMENT and the MOTOR INSURANCE DATABASE Information relating to your policy will be added to the Motor Insurance Database ('MID') managed by the Motor Insurance Bureau ('MIB'). MID and the data stored on it may be used by certain statutory and/or authorised bodies including the Police, the DVLA, the Insurance Fraud Bureau and other bodies permitted by law for purposes not limited to but including:</p>
                                                                      <ul style=" list-style-type: none; padding: 0; margin: 0;">
                                                                        ...
                                                                        <li style="margin-bottom: 5px;">III Law enforcement (prevention, detection, apprehension and or prosecution of offenders)</li>
                                                                        <li style="margin-bottom: 5px;">IV The provision of government services and or other services aimed at reducing the level and incidence of uninsured driving.</li>
                                                                      </ul>
                                                                      <p style=" margin-bottom: 10px;">If you are involved in a road traffic accident (either in the UK, EEA or certain other territories), insurers and or the MIB may search the MID to obtain relevant information.</p>
                                                                      <p style="margin-bottom: 10px;">Persons (including his or her appointed representatives) pursuing a claim in respect of a road traffic accident (including citizens of other countries) may also obtain information which is held on the MID. It is vital that the MID holds your correct registration number. If it is incorrectly shown on MID you are at risk of having your vehicle seized by the Police.</p>
                                                                    </div>
