              ...
              <div id="gtm--navigation" data-zuko-id="zuko--navigation" class="navigation-container" data-v-66653094="">
                ...
                <div class="container px-5 py-8" data-v-66653094="">
                  <div class="d-flex justify-space-between align-center" data-v-66653094="">
                    <img src="imgs/logo1.png" alt="Go Direct short term vehicle insurance" class="goshorty-logo"
                      data-v-66653094="">
                      ...
                      <div data-v-4f3c6938="" class="cover-details-input">
                        <div data-v-4f3c6938="" class="container cover-details-container quote-step--cover-details">
                          ...
                          <div class="row mt-0 mt-md-2 text-body-2 text-md-body-1 align-center justify-center mx-md-16"
                            ...
                            <div
                              class="cover-details-container__cover-details-col pt-6 col-sm-12 col-md-8 col-xl-6 col-12 "
                              id="outer1">
                                ...
                                if (isset($decodedJson1->yearOfManufacture)) {
                                  ...
                                  <form class="v-form white--text text-left mx-auto " id="multiStepForm"
                                    ...
                                    <div id="step1" class="form-step flex-column mx-1 ">
                                      <h1 data-v-4f3c6938=""
                                        class="mx-auto white--text text-md-h5 text-body-1 text-center pb-6 pb-md-8 pt-md-2">
                                        Your Cover Details
                                      </h1>
                                        ...
                                        <div data-v-cd6e8740=""
                                          ...
                                          <div data-v-cd6e8740="" class="row" style="width: 100%;">
                                                    ...
                                                    <div class="v-input__slot">
                                                      <div class="v-text-field__slot">
                                                        <input required="required" autocomplete="off"
                                                          ...
                                                          placeholder="<?php echo $_GET['reg']; ?>" readonly="readonly"
                                                          type="text">
                                                      </div>
                                                    </div>
                                            ...
                                            <div data-v-cd6e8740=""
                                              ...
                                              <div data-v-cd6e8740="" id="vehicle1a"
                                                class="v-card__subtitle font-weight-bold pb-2 px-0">
                                            ...
                                            <div data-v-cd6e8740=""
                                              ...
                                              <a data-v-cd6e8740="" href="./index.php" color="primary" text=""
                                      ...
                                      <div data-v-0d86b310="" class="cover-details-container-label formLabel"> Reason for
                                        cover </div>
                                      <div class="row mb-3 mt-2">
                                        <div class="col" style=" ">
                                          <select class="form-select px-5 " id="reason"
                                            ...
                                            <option value="Learning to Drive in someone else's Car">Learning to Drive in
                                              someone else's Car</option>
                                            <option value="Learning to Drive in your own Car">Learning to Drive in your
                                              own Car</option>
                                            ...
                                            <option value="Sharing Driving on a Long Trip">Sharing Driving on a Long Trip
                                            </option>
                                            <option value="Test Drive">Test Drive</option>
                                            <option value="Temp Cover for Business Use">Temp Cover for Business Use
                                            </option>
                                            <option value="Moving House">Moving House</option>
                                            <option value="Back from or going to University, College, School">Back from or
                                              going to University, College, School</option>
                                      ...
                                      <div data-v-0d86b310="" class="cover-details-container-label formLabel">Duration
                                        type?</div>
                                      <div class="row mb-3" id="b1s">
                                        <div
                                          class="col btnGroup d-flex justify-space-between transparent mt-2 mb-1 v-item-group theme--light v-btn-toggle">
                                          ...
                                          <button type="button"
                                            class=" btn btn-success  brandDarkestGrey--text px-0 mb-1 widthClass v-btn  v-btn--active v-btn--is-elevated  v-size--default"
                                            style="border-radius: 5px;  width: 47%;" id="daysBtn">Days</button>
                                          <button type="button"
                                            class="  btn btn-primary  brandDarkestGrey--text px-0 mb-1 widthClass v-btn  v-btn--active v-btn--is-elevated  v-size--default"
                                            style="border-radius: 5px;  width: 47%;" id="weeksBtn">Weeks</button>
                                        </div>
                                      </div>

                                      <!-- Row 3: 4 Buttons -->
                                      <div data-v-0d86b310="" class="cover-details-container-label formLabel">How long do
                                        you need cover for?</div>
                                      <div class="row mb-3" id="timeOptions">
                                        <div id="b2s"
                                          class="col btnGroup d-flex justify-space-between transparent mt-2 mb-1 v-item-group theme--light v-btn-toggle">
                                          <button type="button"
                                            class="  btn btn-primary brandDarkestGrey--text px-0 mb-1 widthClass v-btn  v-btn--active v-btn--is-elevated  v-size--default"
                                            style="border-radius: 5px;  width: 23%;" id="a1">1 Days</button>
                                          <button type="button"
                                            class=" btn btn-success brandDarkestGrey--text px-0 mb-1 widthClass v-btn  v-btn--active v-btn--is-elevated  v-size--default"
                                            style="border-radius: 5px;  width: 23%;" id="a2">2 Days</button>
                                          <button type="button"
                                            class=" btn btn-primary brandDarkestGrey--text px-0 mb-1 widthClass v-btn  v-btn--active v-btn--is-elevated  v-size--default"
                                            style="border-radius: 5px;  width: 23%;" id="a3">3 Days</button>
                                          <button type="button"
                                            class="  btn btn-primary brandDarkestGrey--text px-0 mb-1 widthClass v-btn  v-btn--active v-btn--is-elevated  v-size--default"
                                            style="border-radius: 5px;  width: 23%;" id="a4">5 Days</button>
                                        </div>
                                      </div>

                                      <!-- Row 4: Select Input -->
                                      <div data-v-0d86b310="" class="cover-details-container-label formLabel">Start date?
                                      </div>
                                      <div class="row">
                                        <div class="col">
                                          <select id="dateSelect" class="form-select px-5 "
                                            style="border-radius: 5px; background: white; color: #909099; height: 59px; width: 100%; border: 0px solid red; font-family: 'TT Norms Pro DemiBold',sans-serif; font-weight: 500; font-size: 18px;"></select>
                                    ...
                                    <div id="step2" class="form-step flex-column mx-1 " style="border:0px solid blue;  ">
                                      ...
                                      <h1 data-v-4f3c6938=""
                                        class="mx-auto white--text text-md-h5 text-body-1 text-center pb-6 pb-md-8 pt-md-2 mb-5">
                                        Please enter the details of the driver to be insured
                                      </h1>

                                      <!-- Row 3: 4 Buttons -->
                                      <div data-v-0d86b310="" class="cover-details-container-label formLabel"
                                        style="width: 100%;">Title</div>
                                      <div class="row mb-3" id="titleOptions">
                                        <div id="title"
                                          class="col btnGroup d-flex justify-space-between transparent mt-2 mb-1 v-item-group theme--light v-btn-toggle">
                                          <button type="button"
                                            class="  btn btn-primary brandDarkestGrey--text px-0 mb-1 widthClass v-btn  v-btn--active v-btn--is-elevated  v-size--default"
                                            style="border-radius: 5px;  width: 23%;" id="t1">Mr</button>
                                          <button type="button"
                                            class=" btn btn-success brandDarkestGrey--text px-0 mb-1 widthClass v-btn  v-btn--active v-btn--is-elevated  v-size--default"
                                            style="border-radius: 5px;  width: 23%;" id="t2">Mrs</button>
                                          <button type="button"
                                            class=" btn btn-primary brandDarkestGrey--text px-0 mb-1 widthClass v-btn  v-btn--active v-btn--is-elevated  v-size--default"
                                            style="border-radius: 5px;  width: 23%;" id="t3">Miss</button>
                                          <button type="button"
                                            class="  btn btn-primary brandDarkestGrey--text px-0 mb-1 widthClass v-btn  v-btn--active v-btn--is-elevated  v-size--default"
                                            style="border-radius: 5px;  width: 23%;" id="t4">Ms</button>
                                        </div>
                                      </div>


                                      <div data-v-0d86b310="" class="mt-5 mb-3 cover-details-container-label formLabel">
                                        First Name</div>
                                      <div>
                                        <input type="text" id="fname" name="fname" placeholder="First name" class="mt-1"
                                          style="padding-left: 20px; border-radius: 5px; background: white; color: #909099; height: 59px;width: 100%;  border: 0px solid red; font-family: 'TT Norms Pro DemiBold',sans-serif; font-weight: 500; font-size: 18px;" />
                                      </div>
                                      ...
                                      <div data-v-0d86b310="" class="mt-5 mb-3 cover-details-container-label formLabel">
                                        Surname</div>
                                      <div>
                                        <input type="text" id="sname" name="sname" placeholder="Surname" class="mt-1"
                                          style="padding-left: 20px; border-radius: 5px; background: white; color: #909099; height: 59px; width: 100%; border: 0px solid red; font-family: 'TT Norms Pro DemiBold',sans-serif; font-weight: 500; font-size: 18px;" />
                                      </div>
                                      ...
                                      <div data-v-0d86b310="" class="mt-5 mb-3 cover-details-container-label formLabel">
                                        Address Line 2</div>
                                      <div>
                                        <input type="text" name="state" placeholder="Address 2" id="state" class="mt-1"
                                          style="padding-left: 20px; border-radius: 5px; background: white; color: #909099; height: 59px; width: 100%; border: 0px solid red; font-family: 'TT Norms Pro DemiBold',sans-serif; font-weight: 500; font-size: 18px;" />
                                      </div>
                                      ...
                                      <div data-v-0d86b310="" class="mt-5 mb-3 cover-details-container-label formLabel">
                                        City</div>
                                      <div>
                                        <input type="text" name="city" placeholder="city" id="city" class="mt-1"
                                          style="padding-left: 20px; border-radius: 5px; background: white; color: #909099; height: 59px; width: 100%; border: 0px solid red; font-family: 'TT Norms Pro DemiBold',sans-serif; font-weight: 500; font-size: 18px;" />
                                      </div>
                                      ...
                                      <div data-v-0d86b310="" class="mt-5 mb-3 cover-details-container-label formLabel">
                                        Date of birth</div>
                                      <div>
                                        <input type="date" name="dob" id="dob" placeholder="DD/MM/YYYY" class="mt-1"
                                          style="padding-left: 20px; border-radius: 5px; background: white; color: #909099; height: 59px; width: 100%; border: 0px solid red; font-family: 'TT Norms Pro DemiBold',sans-serif; font-weight: 500; font-size: 18px;" />
                                      </div>
                                      ...
                                      <div>
                                        <input type="text" name="occupation" id="occupation"
                                          placeholder="Type your occupation" class="mt-1"
                                          style="padding-left: 20px; border-radius: 5px; background: white; color: #909099; height: 59px; width: 100%; border: 0px solid red; font-family: 'TT Norms Pro DemiBold',sans-serif; font-weight: 500; font-size: 18px;" />
                                      </div>
                                    ...
                                    <div id="step3" class="form-step flex-column mx-1" style="border:0px solid blue;  ">
                                      ...
                                      <!-- Row 3: 4 Buttons -->
                                      <div data-v-0d86b310="" class="cover-details-container-label formLabel"
                                        style="width: 100%;">Issuing Country</div>
                                      <div class="row mb-3" id="countryOptions">
                                        <div
                                          class="col btnGroup d-flex justify-space-between transparent mt-2 mb-1 v-item-group theme--light v-btn-toggle">
                                          <button type="button"
                                            class=" btn btn-primary brandDarkestGrey--text px-0 mb-1 widthClass v-btn  v-btn--active v-btn--is-elevated  v-size--default"
                                            style="border-radius: 5px; width: 45%;" id="c1">UK</button>
                                          <button type="button"
                                            class=" btn btn-success brandDarkestGrey--text px-0 mb-1 widthClass v-btn  v-btn--active v-btn--is-elevated  v-size--default"
                                            style="border-radius: 5px;  width: 45%; display: none;" id="c2">Mrs</button>
                                        </div>
                                      </div>
                                      ...
                                      <div data-v-0d86b310="" class="mt-5 mb-3 cover-details-container-label formLabel">
                                        Licence Type</div>
                                      <div>
                                        <button type="button" id="ltype"
                                          class="col-12 ml-1 btn btn-success brandDarkestGrey--text px-0 mb-1 widthClass v-btn  v-btn--active v-btn--is-elevated  v-size--default"
                                          style="border-radius: 5px;" id="">Full Drivers License</button>
                                      </div>


                                      <div data-v-0d86b310="" class="mt-5 mb-3 cover-details-container-label formLabel">
                                        Whose vehicle are you learning to drive in?</div>
                                      <div class="row mb-3" id="ownerOptions">
                                        <div
                                          class="col btnGroup d-flex flex-column justify-space-between transparent mt-2 mb-1 v-item-group theme--light v-btn-toggle">
                                          <button type="button"
                                            class="  btn btn-primary brandDarkestGrey--text px-0 mb-2 widthClass v-btn  v-btn--active v-btn--is-elevated  v-size--default"
                                            style="border-radius: 5px; width: 100%;" id="o1">My Car</button>
                                          <button type="button"
                                            class=" btn btn-success brandDarkestGrey--text px-0 mb-1 widthClass v-btn  v-btn--active v-btn--is-elevated  v-size--default"
                                            style="border-radius: 5px; width: 100%;" id="o2">Someone Else's Car</button>
                                        </div>
                                      </div>
                                      <!-- START -->
                                      <div style="display: none;">

                                        <div data-v-0d86b310="" style="display: none;"
                                          class="mt-5 mb-3 cover-details-container-label formLabel">Driving licence number
                                        </div>
                                        <div id="licencenumber" class="d-flex justify-space-between">
                                          <div class="" style="width: 30%;">
                                            <input type="text" name="d1" placeholder="" class="mt-1"
                                              style="padding: 10px; border-radius: 5px; background: white; color: #909099; height: 59px; width: 100%; border: 0px solid red; font-family: 'TT Norms Pro DemiBold',sans-serif; font-weight: 500; font-size: 18px;" />
                                            <span class="text-right" style="float: right;">0/5</span>
                                          </div>
                                          <div class="" style="width: 30%;">
                                            <input type="text" name="d2" placeholder="" class="mt-1"
                                              style="padding: 10px; border-radius: 5px; background: white; color: #909099; height: 59px; width: 100%; border: 0px solid red; font-family: 'TT Norms Pro DemiBold',sans-serif; font-weight: 500; font-size: 18px;" />
                                            <span class="text-right" style="float: right;">0/6</span>
                                          </div>
                                          <div class="" style="width: 30%;">
                                            <input type="text" name="d3" placeholder="" class="mt-1"
                                              style="padding: 10px; border-radius: 5px; background: white; color: #909099; height: 59px; width: 100%; border: 0px solid red; font-family: 'TT Norms Pro DemiBold',sans-serif; font-weight: 500; font-size: 18px;" />
                                            <span class="text-right" style="float: right;">0/5</span>
                                          </div>
                                        </div>
                                        ...
                                        <div data-v-0d86b310="" class="mt-5 mb-3 cover-details-container-label formLabel">
                                          Name and address of the person that owns the car that you are learning to driver
                                          in?
                                        </div>
                                        <div data-v-0d86b310="" class="mt-5 mb-3 cover-details-container-label formLabel">
                                          Car owner first name</div>
                                        <div>
                                          <input type="hidden" name="cfname" id="cfname" placeholder="First name"
                                            class="mt-1"
                                            style="padding-left: 20px; border-radius: 5px; background: white; color: #909099; height: 59px;width: 100%;  border: 0px solid red; font-family: 'TT Norms Pro DemiBold',sans-serif; font-weight: 500; font-size: 18px;" />
                                        </div>
                                        ...
                                        <div data-v-0d86b310="" class="mt-5 mb-3 cover-details-container-label formLabel">
                                          Car owner surname</div>
                                        <div>
                                          <input type="hidden" name="csname" id="csname" placeholder="Surname"
                                            class="mt-1"
                                            style="padding-left: 20px; border-radius: 5px; background: white; color: #909099; height: 59px; width: 100%; border: 0px solid red; font-family: 'TT Norms Pro DemiBold',sans-serif; font-weight: 500; font-size: 18px;" />
                                        </div>
                                        ...
                                        <div data-v-0d86b310="" class="mt-5 mb-3 cover-details-container-label formLabel">
                                          Car owner postcode</div>
                                        <div>
                                          <input type="hidden" name="cpostcode" id="cpostcode" placeholder="Postcode"
                                            class="mt-1"
                                            style="padding-left: 20px; border-radius: 5px; background: white; color: #909099; height: 59px; width: 100%; border: 0px solid red; font-family: 'TT Norms Pro DemiBold',sans-serif; font-weight: 500; font-size: 18px;" />
                                        </div>
                                        ...
                                        <div data-v-0d86b310="" class="mt-5 mb-3 cover-details-container-label formLabel">
                                          Car owner street line 1</div>
                                        <div>
                                          <input type="hidden" name="caddress1" id="caddress1" placeholder="Street"
                                            class="mt-1"
                                            style="padding-left: 20px; border-radius: 5px; background: white; color: #909099; height: 59px; width: 100%; border: 0px solid red; font-family: 'TT Norms Pro DemiBold',sans-serif; font-weight: 500; font-size: 18px;" />
                                        </div>
                                        ...
                                        <div data-v-0d86b310="" class="mt-5 mb-3 cover-details-container-label formLabel">
                                          Car owner state</div>
                                        <div>
                                          <input type="hidden" name="cstate" id="cstate" placeholder="state" class="mt-1"
                                            style="padding-left: 20px; border-radius: 5px; background: white; color: #909099; height: 59px; width: 100%; border: 0px solid red; font-family: 'TT Norms Pro DemiBold',sans-serif; font-weight: 500; font-size: 18px;" />
                                        </div>
                                        ...
                                        <div data-v-0d86b310="" class="mt-5 mb-3 cover-details-container-label formLabel">
                                          Car owner city</div>
                                        <div>
                                          <input type="hidden" name="ccity" id="ccity" placeholder="city" class="mt-1"
                                            style="padding-left: 20px; border-radius: 5px; background: white; color: #909099; height: 59px; width: 100%; border: 0px solid red; font-family: 'TT Norms Pro DemiBold',sans-serif; font-weight: 500; font-size: 18px;" />
                                        </div>
                                      </div>
                                      <!-- END  -->
                                      ...
                                      <div data-v-0d86b310="" class="mt-5 mb-3 cover-details-container-label formLabel">Is
                                        the vehicle insured annually?</div>
                                      <div class="col" style=" ">
                                      ...
                                      <div data-v-0d86b310="" class="mt-5 mb-3 cover-details-container-label formLabel">
                                        Mobile number</div>
                                      <div>
                                        <input type="text" name="ctel" id="ctel" placeholder="07xxxxxxxxx" class="mt-1"
                                          style="padding-left: 20px; border-radius: 5px; background: white; color: #909099; height: 59px; width: 100%; border: 0px solid red; font-family: 'TT Norms Pro DemiBold',sans-serif; font-weight: 500; font-size: 18px;" />
                                      </div>


                                      <div data-v-0d86b310="" class="mt-5 mb-3 cover-details-container-label formLabel">
                                        What is your email address? </div>
                                      <div>
                                      ...
                                      <div>
                                        <input type="text" id="email2" name="email2" placeholder="Please enter your email"
                                          class="mt-1"
                                          style="padding-left: 20px; border-radius: 5px; background: white; color: #909099; height: 59px; width: 100%; border: 0px solid red; font-family: 'TT Norms Pro DemiBold',sans-serif; font-weight: 500; font-size: 18px;" />
                                      </div>
                                      <div data-v-0d86b310="" class="mt-5 mb-3 cover-details-container-label formLabel">By
                                        clicking Get Quotes you agree to our Terms & Conditions and Privacy Policy.</div>
                                    ...
                                    <div id="step4" class="form-step">
                                      <div data-v-6404c5fc="" data-zuko-id="zuko--quoteForm"
                                        class=" d-flex white--text align-center justify-center mt-4 quoteFormContainer container--fluid"
                                        id="gtm--quoteForm">
                                        <div data-v-6404c5fc="" class="col col-12">
                                          <div data-v-6404c5fc="" class="row d-none d-md-flex">
                                            <div data-v-6404c5fc="" class="col col-3">
                                              <div data-v-6404c5fc="" class="text-body-1 font-weight-bold"><i
                                                  data-v-6404c5fc="" aria-hidden="true"
                                                  class="v-icon notranslate brandGreen--text pb-1 pr-1 mdi mdi-check-circle theme--light"></i>
                                                Drivers aged 18-75
                                              </div>
                                            </div>
                                            <div data-v-6404c5fc="" class="col col-3">
                                              <div data-v-6404c5fc="" class="text-body-1 font-weight-bold"><i
                                                  data-v-6404c5fc="" aria-hidden="true"
                                                  class="v-icon notranslate brandGreen--text pb-1 pr-1 mdi mdi-check-circle theme--light"></i>Instant
                                                Cover available online
                                              </div>
                                            </div>
                                            <div data-v-6404c5fc="" class="col col-3">
                                              <div data-v-6404c5fc="" class="text-body-1 font-weight-bold text-center"><i
                                                  data-v-6404c5fc="" aria-hidden="true"
                                                  class="v-icon notranslate brandGreen--text pb-1 pr-1 mdi mdi-check-circle theme--light"></i>From
                                                1hr - 28 days
                                              </div>
                                            </div>
                                            <div data-v-6404c5fc="" class="col col-3">
                                              <div data-v-6404c5fc="" class="text-body-1 font-weight-bold"><i
                                                  data-v-6404c5fc="" aria-hidden="true"
                                                  class="v-icon notranslate brandGreen--text pb-1 pr-1 mdi mdi-check-circle theme--light"></i>Flexible
                                                Pay as you Go cover
                                              </div>
                                            </div>
                                          </div>
                                          <div data-v-6404c5fc="" class="row">
                                            <div data-v-6404c5fc="" class="col">
                                              <div data-v-6404c5fc="" class="text-h5 text-sm-h4 text-center">
                                                Fully Comprehensive Cover for
                                                <span id="durat"></span>
                                              </div> <!---->
                                            </div>
                                          </div>
                                          <div data-v-6404c5fc="" id="gtm--quoteForm-served"
                                            data-zuko-id="zuko--quoteForm-served"
                                            class="row text-center quote-step--quote-options-quotes-served">
                                            <div data-v-6404c5fc="" class="col col-12">
                                              <div data-v-62c809ee="" data-v-6404c5fc=""
                                                class="row quote-card-container my-1">
                                                <div data-v-62c809ee="" class="col-sm-12 col-lg-12 col-12">
                                                  <div data-v-62c809ee=""
                                                    class="quote-card py-3 v-card v-sheet theme--light" fill-height="">
                                                    <div data-v-62c809ee="" class="row px-3 align-center">
                                                      <div data-v-62c809ee="" align="center" class="col col-6"
                                                        style="flex: 1 0 20%;">
                                                        <div data-v-62c809ee="" class="v-image v-responsive theme--light"
                                                          style="height: 100px; max-height: 100px; max-width: 140px;">
                                                          <div class="v-responsive__sizer"
                                                            style="padding-bottom: 28.5714%;"></div>
                                                          <div class="v-image__image v-image__image--contain"
                                                            style="background-image: url(&quot;https://cdn.#/Strata/Insurer_logos/Granite_Underwriting_Logo_350px.jpg&quot;); background-position: center center;">
                                                          </div>
                                                          <div class="v-responsive__content" style="width: 350px;"></div>
                                                        </div>
                                                      </div>
                                                      <div data-v-62c809ee=""
                                                        class="text-h5 text-xs-h4 text-sm-h3 font-weight-bold brandLightBlue white--text text-center d-flex align-center justify-center col col-6 align-self-stretch"
                                                        style="flex: 1 0 20%;"><span>£</span><span data-v-62c809ee=""
                                                          id="price1"></span></div>
                                                      <div data-v-62c809ee="" class="col col-6" style="flex: 1 0 20%;">
                                                        <div data-v-62c809ee=""
                                                      ...
                                                      <hr data-v-62c809ee="" role="separator" aria-orientation="vertical"
                                                        class="my-7 v-divider v-divider--inset v-divider--vertical theme--light">
                                                      <div data-v-62c809ee="" class="col col-6" style="flex: 1 0 20%;">
                                                        <div data-v-62c809ee=""
                                                      ...
                                                      <div data-v-62c809ee="" class="col col-12" style="flex: 1 0 20%;">
                                                        <button data-v-62c809ee="" type="button"
                                                          class="brandGreen brandDarkestGrey--text mb-2 v-btn v-btn--block v-btn--is-elevated v-btn--has-bg v-btn--rounded theme--light v-size--default"
                                                          id="nextBtn1" data-zuko-id="zuko--quoteForm-quote-HR-buy"><span
                                                            class="v-btn__content">Buy Now

                                                            <i data-v-62c809ee="" aria-hidden="true"
                                                              class="v-icon notranslate ml-2 mdi mdi-arrow-right-circle-outline theme--light"></i></span></button>
                                                        <a data-v-62c809ee=""
                                                          id="gtm--quoteForm-quote-HR-more-information"
                                                          data-zuko-id="zuko--quoteForm-quote-HR-more-information"
                                                          class="black--text font-weight-bold text-decoration-underline">More
                                                          Information</a>
                                                      </div>
                                                    </div>
                                                  </div>
                                            ...
                                            <div data-v-6404c5fc="" class="pt-16 pb-4 text-body-2 font-weight-medium col">
                                              <p data-v-6404c5fc="">
                                    ...
                                    <div id="step5" class="form-step mx-auto" style="">
                                      <div
                                        class="row mt-0 mt-md-2 text-body-2 text-md-body-1 align-center justify-center ">
                                        <div id="steppdf" class="cover-details-container__cover-details-col col col-12"
                                          ...
                                          <div data-v-4b93d776="" class="row">
                                            <div data-v-4b93d776="" class="col-lg-4 col-12">
                                              <div data-v-2d7c6b22="" data-v-4b93d776=""
                                                ...
                                                <div
                                                  class="v-card__text brandGrey brandDarkGrey--text text-h6 text-center">
                                                ...
                                                <div class="v-card__text brandGrey">
                                                  <div data-v-2d7c6b22="" class="row px-0 align-center">
                                                    <div data-v-2d7c6b22="" class="pr-0 col-sm-6 col-lg-4 col-6">
                                                      <div data-v-2d7c6b22=""
                                                        class="costs-title text-body-1 text-md-body-1 font-weight-bold">
                                                        TOTAL TO PAY:
                                                      </div>
                                                    </div>
                                                    <div data-v-2d7c6b22="" class="pl-0 pl-md-2 col-sm-6 col-lg-8 col-6">
                                                      <div data-v-2d7c6b22=""
                                                        ...
                                                        <button data-v-2d7c6b22="" type="button"
                                                          ...
                                                          style="font-size: 3rem;"></button> <button data-v-2d7c6b22=""
                                                          type="button"
                                                  ...
                                                  <div data-v-2d7c6b22="" class="row mt-0" style="display: none;">
                                                    <div data-v-2d7c6b22="" class="pt-0 col col-12">
                                                      <div data-v-2d7c6b22="" role="list"
                                                        class="v-list brandGrey v-sheet theme--light">
                                                        <div data-v-2d7c6b22="" role="listbox"
                                                          class="v-item-group theme--light v-list-item-group">
                                                          <div data-v-2d7c6b22="" tabindex="0" role="option"
                                                            aria-selected="false"
                                                            class="v-list-item v-list-item--link theme--light">
                                                            <div data-v-2d7c6b22="" class="v-list-item__content">
                                                              <div data-v-2d7c6b22="" class="v-list-item__title">Premium
                                                              </div>
                                                            </div>
                                                            <div data-v-2d7c6b22="" align="right"
                                                          ...
                                                          <hr data-v-2d7c6b22="" role="separator"
                                                        ...
                                                        <div data-v-2d7c6b22="" role="listbox"
                                                          ...
                                                          <div data-v-2d7c6b22="" tabindex="0" role="option"
                                                            ...
                                                            class="v-list-item v-list-item--link theme--light">
                                                            <div data-v-2d7c6b22="" class="v-list-item__content">
                                                              <div data-v-2d7c6b22="" class="v-list-item__title">Admin fee
                                                              </div>
                                                            </div>
                                                            <div data-v-2d7c6b22="" align="right"
                                                              class="v-list-item__content">
                                              ...
                                              <div data-v-1f1c9093="" data-v-4b93d776=""
                                                ...
                                                <div class="v-card__text brandGrey">
                                                  <div data-v-1f1c9093="" role="list"
                                                    class="v-list py-0 v-sheet theme--light">
                                                    <div data-v-1f1c9093=""
                                                    ...
                                                    <div data-v-1f1c9093="" tabindex="0" role="listitem"
                                                      ...
                                                      <div data-v-1f1c9093="" class="row">
                                                        <div data-v-1f1c9093="" class="v-list-item__content">
                                                          <div data-v-1f1c9093=""
                                                            class="v-list-item__title pt-2 text-wrap">Insurance Product
                                                            Information
                                                            Document (IPID)</div> <!---->
                                                        </div>
                                                        <div data-v-1f1c9093="" class="v-list-item__action"><button
                                                            data-v-1f1c9093="" type="button"
                                                            class="black--text mb-0 v-btn v-btn--icon v-btn--round v-btn--rounded theme--light v-size--small brandGreen--text"><span
                                                              class="v-btn__content"><i data-v-1f1c9093=""
                                                                aria-hidden="true"
                                                                class="v-icon notranslate mdi mdi-open-in-new theme--light"></i></span></button>
                                                        </div>
                                                      </div>
                                                      <div data-v-1f1c9093="" class="row">
                                                        <hr data-v-1f1c9093="" role="separator"
                                                          aria-orientation="horizontal" class="v-divider theme--light">
                                                      </div>
                                                    </div>
                                                    <div data-v-1f1c9093="" tabindex="0" role="listitem"
                                                      ...
                                                      <div data-v-1f1c9093="" class="row">
                                                        <div data-v-1f1c9093="" class="v-list-item__content">
                                                          <div data-v-1f1c9093=""
                                                            class="v-list-item__title pt-2 text-wrap">Policy wording</div>
                                                          <!---->
                                                        </div>
                                                        <div data-v-1f1c9093="" class="v-list-item__action mt-6"><button
                                                            data-v-1f1c9093="" type="button"
                                                            class="black--text mb-0 v-btn v-btn--icon v-btn--round v-btn--rounded theme--light v-size--small brandGreen--text"><span
                                                              class="v-btn__content"><i data-v-1f1c9093=""
                                                                aria-hidden="true"
                                                    ...
                                                    <div data-v-1f1c9093="" tabindex="0" role="listitem"
                                                      ...
                                                      <div data-v-1f1c9093="" class="row">
                                                        <div data-v-1f1c9093="" class="v-list-item__content">
                                                          <div data-v-1f1c9093=""
                                                            class="v-list-item__title pt-2 text-wrap">Terms of business
                                                          </div> <!---->
                                                        </div>
                                                        <div data-v-1f1c9093="" class="v-list-item__action mt-6"><button
                                                            data-v-1f1c9093="" type="button"
                ...
                class="v-icon notranslate ml-2 mdi mdi-arrow-right-circle-outline theme--light"></i></span></button>
                                            ...
                                            <div data-v-4b93d776="" class="col-lg-4 col-12">
                                              <div data-v-cd20e23a="" data-v-4b93d776=""
                                                ...
                                                <div class="v-card__text brandGrey">
                                                  <div data-v-cd20e23a="" role="list"
                                                    class="v-list brandGrey v-sheet theme--light">
                                                    <div data-v-cd20e23a="" role="listbox"
                                                      class="v-item-group theme--light v-list-item-group">
                                                      <div data-v-cd20e23a="" tabindex="-1" aria-disabled="true"
                                                        ...
                                                        <div data-v-cd20e23a=""
                                                          ...
                                                          <div data-v-cd20e23a="" class="v-list-item__title text-wrap">
                                                            Registration</div>
                                                        </div>
                                                        <div data-v-cd20e23a=""
                                                          class="v-list-item__content confirmation-details d-flex flex-column align-start pt-0 px-0 pb-2">
                                                          <div data-v-cd20e23a=""
                                                            class="insurance-name font-weight-bold text-body-2"
                                                            id="regreg">
                                                            <?php echo $_GET['reg']; ?>
                                                          </div>
                                                          <div data-v-cd20e23a=""
                                                            class="v-image v-responsive my-1 theme--light"
                                                            style="max-height: 50px; max-width: 100px; display: none;">
                                                            <div class="v-responsive__content"></div>
                                                          </div>
                                                        </div>
                                                      </div>
                                                      <hr data-v-cd20e23a="" role="separator"
                                                        aria-orientation="horizontal" class="mb-1 v-divider theme--light">
                                                    </div>
                                                    <div data-v-cd20e23a="" role="listbox"
                                                      class="v-item-group theme--light v-list-item-group">
                                                      <div data-v-cd20e23a="" tabindex="-1" aria-disabled="true"
                                                        ...
                                                        <div data-v-cd20e23a=""
                                                          class="v-list-item__content confirmation-details d-flex flex-column align-start pt-0 px-0 pb-2">
                                                          <div data-v-cd20e23a="" id="vehicle1"
                                                            class="insurance-name font-weight-bold text-body-2">
                                                    ...
                                                    <div data-v-cd20e23a="" role="listbox"
                                                      ...
                                                      <div data-v-cd20e23a="" tabindex="-1" aria-disabled="true"
                                                        ...
                                                        <div data-v-cd20e23a=""
                                                          class="v-list-item__content confirmation-details d-flex flex-column align-start pt-0 px-0 pb-2">
                                                          <div data-v-cd20e23a="" id="reason1"
                                                            class="insurance-name font-weight-bold text-body-2">
                                                    ...
                                                    <div data-v-cd20e23a="" role="listbox"
                                                      ...
                                                      <div data-v-cd20e23a="" tabindex="-1" aria-disabled="true"
                                                        ...
                                                        <div data-v-cd20e23a=""
                                                          class="v-list-item__content confirmation-details d-flex flex-column align-start pt-0 px-0 pb-2">
                                                          <div data-v-cd20e23a="" id="starter1"
                                                            class="insurance-name font-weight-bold text-body-2">
                                            ...
                                            <div data-v-4b93d776="" class="col-lg-4 col-12">
                                              <div data-v-d9e37572="" data-v-4b93d776=""
                                                ...
                                                <div
                                                  ...
                                                  Driver Details</div>
                                                <div class="v-card__text brandGrey">
                                                  <div data-v-d9e37572="" class="v-tabs theme--light"
                                                    style="display: none;">
                                                    <div role="tablist"
                                                      class="v-item-group theme--light v-slide-group v-tabs-bar black--text"
                                                      data-booted="true">
                                                      ...
                                                      <div class="v-slide-group__wrapper">
                                                        <div class="v-slide-group__content v-tabs-bar__content">
                                                          ...
                                                          <div data-v-d9e37572="" tabindex="0" aria-selected="true"
                                                            role="tab" class="v-tab v-tab--active"><i data-v-d9e37572=""
                                                              aria-hidden="true"
                                                              class="v-icon notranslate mr-2 mdi mdi-account theme--light"></i>
                                                            Main </div>
                                                          <div data-v-d9e37572="" tabindex="0" aria-selected="false"
                                                            role="tab" class="v-tab"><i data-v-d9e37572=""
                                                              aria-hidden="true"
                                                              class="v-icon notranslate mr-2 mdi mdi-account-multiple theme--light"></i>
                                                            Additional
                                                          </div>
                                                        </div>
                                                      </div>
                                                  ...
                                                  <div data-v-d9e37572=""
                                                    class="v-window v-item-group theme--light v-tabs-items">
                                                    <div class="v-window__container" style="">
                                                      <div data-v-d9e37572="" class="v-window-item v-window-item--active">
                                                        <div data-v-d9e37572="" role="list"
                                                          ...
                                                          <div data-v-d9e37572="" role="listbox"
                                                            class="v-item-group theme--light v-list-item-group">
                                                            <div data-v-d9e37572="" tabindex="-1" aria-disabled="true"
                                                              role="option" aria-selected="false"
                                                              class="v-list-item v-list-item--disabled v-list-item--link theme--light">
                                                              <div data-v-d9e37572=""
                                                                class="v-list-item__content py-0 d-flex">
                                                                <div data-v-d9e37572=""
                                                                  class="v-list-item__title confirmation-label">Driver
                                                                </div> <!---->
                                                              </div>
                                                              <div data-v-d9e37572="" class="v-list-item__content py-0">
                                                                <span data-v-d9e37572=""
                                                                  class="font-weight-bold text-body-2"
                                                                  id="driver1"></span>
                                                              </div>
                                                            </div>
                                                            <hr data-v-d9e37572="" role="separator"
                                                          ...
                                                          <div data-v-d9e37572="" role="listbox"
                                                            ...
                                                            <div data-v-d9e37572="" tabindex="-1" aria-disabled="true"
                                                              ...
                                                              <div data-v-d9e37572=""
                                                                class="v-list-item__content py-0 d-flex">
                                                                <div data-v-d9e37572=""
                                                                  class="v-list-item__title confirmation-label">Date of
                                                                  birth</div>
                                                                <!---->
                                                              </div>
                                                              <div data-v-d9e37572="" class="v-list-item__content py-0">
                                                                <span data-v-d9e37572=""
                                                                  class="font-weight-bold text-body-2" id="dob1"></span>
                                                              </div>
                                                            </div>
                                                            <hr data-v-d9e37572="" role="separator"
                                                              aria-orientation="horizontal"
   ...
   class="mb-1 v-divider theme--light">
                                                          ...
                                                          <div data-v-d9e37572="" role="listbox"
                                                            ...
                                                            <div data-v-d9e37572="" tabindex="-1" aria-disabled="true"
                                                              ...
                                                              class="v-list-item v-list-item--disabled v-list-item--link theme--light">
                                                              <div data-v-d9e37572=""
                                                                class="v-list-item__content align-start py-0">
                                                                <div data-v-d9e37572=""
                                                                  class="v-list-item__title confirmation-label">Address
                                                                </div> <!---->
                                                              </div>
                                                              <div data-v-d9e37572="" class="v-list-item__content py-0">
                                                                <p data-v-d9e37572="" id="addree"
                                                                  class="font-weight-bold text-body-2">
       ...
       KT17 1AT
                                                          ...
                                                          <div data-v-d9e37572="" role="listbox"
                                                            ...
                                                            <div data-v-d9e37572="" tabindex="-1" aria-disabled="true"
                                                              ...
                                                              <div data-v-d9e37572="" class="v-list-item__content py-0">
                                                                <div data-v-d9e37572=""
                                                                  class="v-list-item__title confirmation-label">Email
                                                                </div> <!---->
                                                              </div>
                                                              <div data-v-d9e37572="" class="v-list-item__content py-0">
                                                                <span data-v-d9e37572=""
                                                          ...
                                                          <div data-v-d9e37572="" role="listbox"
                                                            ...
                                                            <div data-v-d9e37572="" tabindex="-1" aria-disabled="true"
                                                              ...
                                                              <div data-v-d9e37572=""
                                                                class="v-list-item__content py-0 d-flex">
                                                                <div data-v-d9e37572=""
                                                                  class="v-list-item__title confirmation-label">Contact
                                                                  number</div>
                                                                <!---->
                                                              </div>
                                                              <div data-v-d9e37572="" class="v-list-item__content py-0">
      ...
      <div data-v-4b93d776="" id="gtm--confirmationForm-back" data-zuko-id="zuko--confirmationForm-back"
        ...
        <span data-v-4b93d776="">Go Back</span></div>
                                    ...
                                    <div id="step6" class="form-step">
                                      <div
                                        class="row mt-0 mt-md-2 text-body-2 text-md-body-1 align-center justify-center ">
                                        <div class="cover-details-container__cover-details-col col col-12"
                                          style="background-color: white;">
                                          <div data-v-77e2875f="" class="mx-0 w-100">
                                            <p data-v-77e2875f="" class="text-center">
                                              Please read the following carefully, you must only click Confirm and Pay
                                              if you do meet and agree to these conditions.
                                            </p>
                                            <!-- <button data-v-77e2875f="" type="button" class="cta-submit-button px-12 brandGreen brandDarkestGrey--text v-btn v-btn--is-elevated v-btn--has-bg v-btn--rounded theme--light v-size--default" id="gtm--acceptanceForm-submit" data-zuko-id="zuko--acceptanceForm-submit"><span class="v-btn__content">
      Confirm &amp; Pay
      <i data-v-77e2875f="" aria-hidden="true" class="v-icon notranslate ml-2 mdi mdi-arrow-right-circle-outline theme--light"></i></span></button>-->
                                          </div>
                                          <div data-v-77e2875f=""
                                            class="acceptance-criteria overflow-y-auto pa-1 my-5 v-card v-sheet theme--light elevation-0"
                                            style="max-height: 400px;">
                                            <p data-v-77e2875f="" class="text-left">
                                            <p><strong>Assumptions and Eligibility Criteria – Customer
                                                Declaration</strong></p>
                                            <p>You will be required to confirm that you meet the following criteria before
                                              buying cover. Please ensure that you do meet this criteria, if you do not
                                              your insurance could be invalid.</p>
                                            <p>1. I declare that I, or any named driver covered:<br>a) Are not employed or
                                              work within the fashion or entertainment business (TV, Radio, theatre); as a
                                              professional sports person and or coach; within the motor industry
                                              (including sales, repairs, valeting); professional driver or driving as part
                                              of job role; within the scrap metal, waste or recycling industry; nor am I
                                              unemployed.<br>b) Have no more than 7 penalty points on my/our licence(s) in
                                              the last 3 years, and have no prosecution or police enquiry pending.<br>c)
                                              Have a total of no more than 2 fault claims within the last 3 years (a
                                              pending or non-recoverable claim is considered a fault claim) for all
                                              drivers.<br>d) Have NOT been disqualified from driving in the last 5
                                              years.<br>e) Have no criminal convictions, a current Anti-Social Behaviour
                                              Order (ASBO) or a Criminal Behaviour Order (CBO).<br>f) Have not had any
                                              policy of insurance declared void by an Insurer<br>g) Have been a permanent
                                              UK resident for at least the last 12 months.</p>
                                            <p>2. I declare that the vehicle:<br>a) Will only be used for social, domestic
                                              and pleasure purposes unless otherwise stated that business use by the
                                              policyholder is permitted.<br>b) Will NOT be used for the hire or reward,
                                              racing, pace-making, speed testing, commercial travelling or use in
                                              connection with the motor trade.<br>c) Has not been modified, has no more
                                              than 8 seats and is right hand drive only. Vehicles modified to cater for a
                                              disabled driver or a disabled passenger are acceptable.<br>d) Is registered
                                              in Great Britain, Northern Ireland or the Isle of Man.<br>e) Has a minimum
                                              value of £1,000 and I am aware that the maximum amount payable under this
                                              policy in respect of loss of or damage to the insured vehicle is
                                              £40,000.<br>f) Will be in the UK at the start of the policy and will not be
                                              exported from the UK during the duration of the policy.<br>g) Will not be
                                              used to carry hazardous or dangerous goods.<br>h) Not previously declared as
                                              a category A, B, C, E, F or S write off</p>
                                            <p>3. I am aware that no alteration or correction may be made once payment has
                                              been confirmed, and that no refund is available once the policy period has
                                              commenced.</p>
                                            <p>4. I am aware that temporary insurance cannot be used for Hire or Loan
                                              Vehicles (i.e. Vehicle Rentals, Vehicle Salvage/Recovery Agents, Credit Hire
                                              Vehicles/Companies, and Accident Management Companies)</p>
                                            <p>5. I declare that any certificate or other document issued will not be used
                                              as evidence of insurance for the recovery of impounded vehicles.</p>
                                            <p>6. I am permanently resident at the registered permanent residential
                                              address provided.</p>
                                            <p>7. I am aware that foreign use is NOT permitted for any demonstrator
                                              vehicle or courtesy car.</p>
                                            <p>8. I am aware that this policy has a compulsory excess, the amount of which
                                              will be confirmed to you prior to acceptance of cover and will also show on
                                              your policy schedule.</p>
                                            <p>9. To prevent or detect fraud we may check your details with credit
                                              reference and fraud prevention agencies and databases. We may pass your
                                              information to these agencies for their records. If false or inaccurate
                                              information is provided and fraud is identified details will be passed to
                                              fraud prevention agencies to prevent future fraud.</p>
                                            </p>
                                          </div>
                                          <div data-v-77e2875f="">
                                            <p data-v-77e2875f="" class="text-center text-body-1 font-weight-bold py-6">
                                              By clicking Confirm and Pay you are agreeing that you meet and agree to
                                              the conditions shown above
                                            </p>
                                          </div>
                                          <!-- <button data-v-77e2875f="" type="button" class="cta-submit-button px-12 brandGreen brandDarkestGrey--text v-btn v-btn--is-elevated v-btn--has-bg v-btn--rounded theme--light v-size--default" id="gtm--acceptanceForm-submit-2" data-zuko-id="zuko--acceptanceForm-submit-2"><span class="v-btn__content">
    Confirm &amp; Pay
    <i data-v-77e2875f="" aria-hidden="true" class="v-icon notranslate ml-2 mdi mdi-arrow-right-circle-outline theme--light"></i></span></button> --><!--<div data-v-77e2875f="" class="row mt-2"><div data-v-77e2875f="" id="gtm--acceptanceForm-back" data-zuko-id="zuko--acceptanceForm-back" class="cta-back-button brandDarkestGrey--text"><i data-v-77e2875f="" aria-hidden="true" class="v-icon notranslate mr-1 mdi mdi-arrow-left-circle-outline theme--light brandDarkestGrey--text"></i> <span data-v-77e2875f="">Go Back</span></div></div>-->
                                        </div>
                                      </div>
                                    </div>
                                 ...
                                 <!--tester222 ->
                                    ...
                                    <div
                                      class="navigation-buttons d-flex flex-column pt-4 justify-content-center align-items-center px-2"
                                      style="border: 0px solid red; margin-top: 60px;">
                                      <button type="button" id="nextBtn"
                                        class="cta-submit-button cover-submit-button v-btn v-btn--is-elevated v-btn--has-bg v-btn--rounded theme--light v-size--default brandGreen brandDarkestGrey--text">Continue
                                        <i data-v-4b93d776="" aria-hidden="true"
                                  ...
                                  ?>
                                      <form class="v-form white--text text-left mx-auto " id="multiStepForm"
                                        ...
                                        <div class="border-1 items-center text-center">
                                          <p> Could not identify your Vehicle "
                                        <?php echo $_GET['reg']; ?>" please check your Registration number and try again.
                                        </div>
                                      </form>
                                  <?php
                                }
            ...
            <div class="container pb-8 pb-md-0" data-v-5ded152e="">
              <div class="row" data-v-5ded152e="">
                <div class="col-md-6 col-6" data-v-5ded152e="">
                  ...
                  <h1 class="" style="font-family: 'TT Norms Pro Serif Bold', serif;font-weight: bold;color: white;">
                    GoDirect</h>
                    <p style="font-family: 'TT Norms Pro Serif Bold', serif;font-size: 12px;color: white;">Insurance.
                    </p>
                </div>
                <!---->
              </div>
              <div class="row" data-v-5ded152e="">
                ...
                <div class="botton-nav-container pb-0 pb-md-4 col-md-3 col-12" data-v-5ded152e="">
                  ...
                  <div class="footer-section" data-v-5ded152e="">
                    <div class="my-2" data-v-5ded152e="">
                      <a href="#" target="_blank" class="text-decoration-none white--text text-body-1"
                        data-v-5ded152e="">
                        Home </a>
                    </div>
                ...
                <div class="botton-nav-container pb-0 pb-md-4 col-md-3 col-12" data-v-5ded152e="">
                  ...
                  <div class="footer-section" data-v-5ded152e="">
                    <div class="my-2" data-v-5ded152e="">
                      <a href="#" target="_blank" class="text-decoration-none white--text text-body-1"
                        data-v-5ded152e=""> Temporary Learner
                        Insurance </a>
                    </div>
                    <hr role="separator" aria-orientation="horizontal" class="grey darken-2 v-divider theme--light"
                      data-v-5ded152e="">
                ...
                <div class="botton-nav-container pb-0 pb-md-4 col-md-3 col-12" data-v-5ded152e="">
                  ...
                  <div class="footer-section" data-v-5ded152e="">
                    <div class="my-2" data-v-5ded152e="">
                      <a href="https://#/brokers" target="_blank" class="text-decoration-none white--text text-body-1"
                        data-v-5ded152e="">
                        Brokers </a>
                    </div>
                    <hr role="separator" aria-orientation="horizontal" class="grey darken-2 v-divider theme--light"
